          ...
          [
            {
              "id": "snap",
              "kind": "apt",
              "label": "Install Obsidian CLI via Snap",
...
- **Obsidian version:** 1.12 or later (requires Early Access version)
- **License:** Catalyst license required
- **Runtime:** Obsidian app must be running (first command launches it automatically)

## Installation and Setup

### 1. Install Obsidian (1.12+ Early Access required)

- Upgrade to the latest Obsidian installer (1.11.7)
- Install the latest Early Access version (1.12.x)
